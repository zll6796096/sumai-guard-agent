...
def test_release_gate_records_current_app_store_truth_and_future_boundaries() -> None:
    ...
    expected_rows = {
        ...
        "App Store Connect record": "BLOCKED",
        ...
        "Archive and signing": "IN PROGRESS",
        "IPA upload and processing": "BLOCKED",
        "Metadata and privacy answers": "PASS",
    ...
    for required in (
        ...
        "com.zll.sumaiguard",
        "SUMAIGUARD-IOS-1",
        "App Attest is enabled",
        "production_traffic_changed: false",
        "validation=PASS",
        "mutation=NONE",
        "international-format review contact",
